...
NXP Semiconductors（旧Philips）製のFMラジオ受信DSPモジュールで、低消費電力・小型設計、I²C制御、自動同調(AFC)、ステレオ復調を備えている。  
...
## RDA5807 用パッケージ
RDA Microelectronics製のFMラジオ受信DSPモジュールで、低消費電力・小型、I²C制御、自動同調(AFC)、ステレオ復調を備えている。  
